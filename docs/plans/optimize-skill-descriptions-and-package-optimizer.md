...
- **Char-count audit passes:** `awk '/^description:/ {v=substr($0,index($0,":")+1); sub(/^[[:space:]]+/,"",v); sub(/[[:space:]]+$/,"",v); sub(/^["'\'']/,"",v); sub(/["'\'']$/,"",v); print length(v), FILENAME}' kit/plugins/*/skills/*/SKILL.md` shows all values ≤160.
