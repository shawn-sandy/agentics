...
- Structural — the same script's checks 1, 2, 3, 5, and 6 cover the frontmatter contract, `allowed-tools` completeness, the verbatim plan-mode guard, the five blast-radius guards, and README plus CHANGELOG registration.
