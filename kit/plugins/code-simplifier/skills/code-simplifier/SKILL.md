...
description: "Analyzes code for smells and complexity. Creates a prioritized refactoring plan targeting the worst offenders. Use when the user asks to simplify code, reduce complexity, or refactor."
