---
name: plan-status
description: Use when the user asks to check, update, or determine the status of a plan file (including agentic plans), when entering or exiting plan mode, when creating or updating plans, or when working with plan files in any capacity — not for stress-testing, validating, or critiquing plan content.
