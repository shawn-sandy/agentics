#!/usr/bin/env python3
"""
PostToolUse hook: enforce plan-agent `/plan-agent:author` (§4) verb-target kebab-case filenames.
...
def main():
    ...
    msg = (
        f"\n[plan-filename] '{os.path.basename(path)}' violates plan-agent `/plan-agent:author` (§4) "
