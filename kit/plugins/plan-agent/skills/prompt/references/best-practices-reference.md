...
This file is consumed by the `prompt` skill to apply the correct technique subset for each prompt type. Each technique maps to a specific phase of the skill's pipeline.
