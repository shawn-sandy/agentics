...
- Include `<meta name="plan-status">`, `<meta name="plan-type">`, `<meta name="plan-created">`, `<meta name="plan-repo">`, `<meta name="plan-file">`, `<meta name="plan-path">`, `<meta name="plan-implement">`, and `<meta name="plan-goal">` tags for machine readability; include `<meta name="plan-workflow" content="…">` when a workflow prompt was generated (omit otherwise); include `<meta name="plan-issue" content="<url>">` when the plan was seeded from an issue reference (omit otherwise)
