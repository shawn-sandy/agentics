---
name: author
description: "Authors implementation plans from a free-text objective. Enforces verb-target filenames, required structure, and plan-mode frontmatter. Use when running `/plan-agent:author <objective>` to create or draft a plan."
