...
- For any over-budget file: suggest running `/skill-reviewer:optimizing-descriptions` to trim it (the WARNING message already includes this pointer — do not duplicate it)
