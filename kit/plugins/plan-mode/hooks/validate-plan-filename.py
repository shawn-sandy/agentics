#!/usr/bin/env python3
"""
PostToolUse hook: enforce plan-mode plugin authoring-plans (§4) verb-target kebab-case filenames.
...
def main():
    ...
    msg = (
        f"\n[plan-filename] '{os.path.basename(path)}' violates plan-mode plugin authoring-plans (§4) "
