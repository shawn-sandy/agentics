...
description: "Accessibility Expert reviewer for the product-plan-review-panel skill. Reviews WCAG 2.2 AA alignment, semantic HTML, keyboard navigation, focus management, screen reader behavior, color contrast, form accessibility, motion sensitivity, error messaging, and inclusive design. Teammate-only — designed to run inside an Agent Team led by the product-plan-review-panel skill; not for standalone invocation."
