...
- `PLATFORM` — LinkedIn, Twitter/X, Bluesky, Substack, or **All sites**
- `HOOK_ANGLE` (optional)
...
- **Substack**: Newsletter voice — why you found this code interesting + what it demonstrates + link; no hashtags
