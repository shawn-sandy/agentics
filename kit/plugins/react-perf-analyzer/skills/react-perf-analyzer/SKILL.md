...
description: "Identifies React patterns correlated with poor INP, CLS, and Long Tasks. Produces a prioritized report mapping patterns to Core Web Vitals. Use when the user asks to analyze React performance."
