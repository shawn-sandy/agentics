...
Assess user value, product strategy, business goals, scope, prioritization,
success metrics, assumptions, release readiness, risks, and tradeoffs.
...
Assess technical feasibility, architecture, backend and system concerns,
dependencies, implementation complexity, scalability, maintainability,
integration risks, and technical unknowns.
...
Assess user flows, usability, interaction design, information architecture,
friction points, clarity, onboarding, empty states, error states, and
...
panel. Assess frontend architecture, component design, state management,
performance, responsiveness, design-system alignment, browser behavior,
testing needs, and implementation standards.
...
panel. Assess WCAG 2.2 AA alignment, semantic HTML, keyboard navigation,
focus management, screen reader behavior, color contrast, form
accessibility, motion sensitivity, error messaging, and inclusive design.
