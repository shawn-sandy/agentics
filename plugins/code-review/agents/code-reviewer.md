---
name: code-reviewer
description: Performs structured code review when delegated by the code-review-agent skill. Do not invoke directly — activated through the code-review-agent skill.
